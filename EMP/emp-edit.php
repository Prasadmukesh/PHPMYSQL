                        ...
                        ?>
                                <form action="Editemployee.php" method="post">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="tel" name="phone" value="<?= $emp['phone']; ?>" class="form-control">
                                    </div>
                                    <div class="mb-3">


                                        <label for="">POST</label>
                                        <input type="text" name="post" value="<?= $emp['post']; ?>" class="form-control">
                                    </div>
                                    <div class="mb-3">

                                        <input type="submit" name="edit-data" class="btn btn-primary" value="Edit Data">
                                    </div>
